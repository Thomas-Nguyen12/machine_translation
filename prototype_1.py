...
Original file is located at
    https://colab.research.google.com/drive/1GktcxPCJpM5lX8JchidgHnAL8H75CPW1
...
hist = model.fit(inputs, outputs, epochs=1, validation_split=0.2, callbacks=[callback], batch_size=16)
